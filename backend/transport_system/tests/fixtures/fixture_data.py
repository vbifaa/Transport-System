...
def stops():
    ...
    for stop_dist in json_stops_dist:
        from_stop = get_object_or_404(Stop, name=stop_dist['from'], msg='Cant find from_stop')
        to_stop = get_object_or_404(Stop, name=stop_dist['to'], msg='Cant find to_stop')
